...
public enum ErrorType {
    ...
    //-----------------------쓰레기통 관련 부분---------------------------
    NOT_FOUND_TRASHCAN(401, "등록된 쓰레기통이 없습니다", "d"),
    NOT_FOUND_USERNAME(401, "등록된 사용자 이름이 없습니다", "d"),
    NOT_FOUND_REST(401, "잔량 기록이 없습니다", "d"),
    NOT_FOUND_SERIAL(401, "입력된 시리얼 넘버가 없습니다", "d"),
    INVALID_LOCATION(401, "유효한 위치 범위가 아닙니다.", "d"),
    NOT_FOUND_NICKNAME(401, "입력된 닉네임이 없습니다", "d"),
    INVALID_REST(401, "잔량은 0~100사이의 숫자로 입력해야합니다.", "d"),
    FAILED_TO_RESTLOG(100, "잔량 저장에 실패했습니다.", "d"),
    FAILED_TO_CATLOG(100, "카테고리 저장에 실패했습니다.", "d"),
    FAILED_TO_CATEGORYID(100, "카테고리 아이디가 전송되지 않았습니다.", "d"),
    NOT_FOUND_CATEGORYID(401, "DB에 저장된 카테고리 분류가 없습니다", "d"),
    NOT_FOUND_CATEGORYNAME(401, "카테고리 이름을 조회할 수 없습니다", "d"),
    //-----------------------숏컷 관련 부분---------------------------
    NOT_FOUND_SHORTCUT(401, "숏컷이 존재하지 않습니다.", "d"),
    USER_SHORTCUT_MISMATCH(401, "유저와 숏컷의 유저 정보가 일치하지 않습니다.", "d");
