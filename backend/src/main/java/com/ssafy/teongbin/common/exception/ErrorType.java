...
public enum ErrorType {
    ...
    INVALID_REST(401, "잔량은 0~100사이의 숫자로 입력해야합니다.", ErrorCategory.TRASHCAN_ERROR.getCategory()),
    FAILED_TO_RESTLOG(100, "잔량 저장에 실패했습니다.", ErrorCategory.TRASHCAN_ERROR.getCategory()),
    FAILED_TO_CATLOG(100, "카테고리 저장에 실패했습니다.", ErrorCategory.TRASHCAN_ERROR.getCategory()),
    FAILED_TO_CATEGORYID(100, "카테고리 아이디가 전송되지 않았습니다.", ErrorCategory.TRASHCAN_ERROR.getCategory()),
    NOT_FOUND_CATEGORYID(401, "DB에 저장된 카테고리 분류가 없습니다", ErrorCategory.TRASHCAN_ERROR.getCategory()),
    NOT_FOUND_CATEGORYNAME(401, "카테고리 이름을 조회할 수 없습니다", ErrorCategory.TRASHCAN_ERROR.getCategory()),
    //-----------------------숏컷 관련 부분---------------------------
