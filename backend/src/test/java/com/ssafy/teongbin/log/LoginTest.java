...
private UserRepository userRepository;
    ...
    void testUserRestLogWithCaching() {
        ...
        Trashcan trashcan = trashcans.get(0);
        String redisKey = "TRASHCAN_LOGS_" + trashcan.getId();
        ...
        assertNotNull(cachedLogs);
        System.out.println("Cached logs: " + cachedLogs);
        assertEquals(result.size(), cachedLogs.size());
    }
